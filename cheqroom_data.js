...
`,
  ...
  <div class="email-template-block" style="margin-top:18px; border-top:1px solid var(--line-soft); padding-top:16px;">
    <div style="display:flex; justify-content:space-between; align-items:center; gap:12px; margin-bottom:6px;">
      <div style="font-weight:700; font-size:13px;">📧 Email Template — Missing Paperwork (Reservation Approaching)</div>
      <button type="button" class="media-btn" data-action="copy-template" style="flex-shrink:0;">📋 Copy Text</button>
    </div>
    ...
    <div class="email-template-text" style="background:var(--bg); border:1px solid var(--line); border-left:4px solid var(--amber); border-radius:6px; padding:12px 14px; font-size:13px; font-family:monospace; white-space:pre-wrap; line-height:1.6; user-select:all;">Subject: Action Required — Missing Paperwork for Equipment Reservation #[RESERVATION #]
