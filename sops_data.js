...
`},
{id:4, title:"The Full Order Lifecycle: Building → Checkout → Check-In → Approvals", topic:"onboarding", updated:"Aug 2026", body:`
  <p>This is the same real workflow new hires get trained on, start to finish. Each stage has its own detailed click-by-click steps in <strong>Policies &amp; Procedures → Staff Operations</strong> (search the section name in quotes below) — this page is the big picture tying them together, not a replacement for those.</p>
  <ol>
