...
export async function applyBatteryNotes(onProgress){
  ...
  const batch = [
    ...
    {id:'3',  batteryNote:'🔋 Canon Battery Pack BP-955 — count varies per unit. Check the unit number label before checkout and confirm the correct amount.'},
    {id:'4',  batteryNote:'🔋 Battery charger included. Battery count may vary per unit — verify count on the unit label before checkout.'},
    {id:'36', batteryNote:'🔋 BP-U960 batteries — quantity varies per unit. Verify the count on the unit before checkout.'},
    {id:'37', batteryNote:'🔋 V-Mount battery plate included. Actual battery count varies per unit — check the unit before checkout.'},
    ...
    {id:'1',  batteryNote:'🔋 BlackMagic Pocket Cinema Camera 6K Pro Kit includes an NP-F570 battery and V-Mount plate — verify both are charged before checkout.'},
    {id:'31', batteryNote:'🔋 4 Sony a7S II batteries are in this kit — verify all are charged before checkout.'},
    {id:'28', batteryNote:'🔋 LP-E8 battery included — verify it is charged before checkout.'},
    {id:'29', batteryNote:'🔋 LP-E10 battery included — verify it is charged before checkout.'},
    {id:'33', batteryNote:'🔋 EN-EL9 battery included — verify it is charged before checkout.'},
    {id:'63', batteryNote:'🔋 BA 20 and BA 30 batteries for the wireless transmitters are in this kit — verify spares are present and charged.'},
    {id:'69', batteryNote:'🔋 8 batteries are inside the radios — verify all are charged before checkout.'},
    {id:'11', batteryNote:'🔋 NPF batteries included — verify they are charged before checkout.'},
    {id:'72', batteryNote:'🔋 NP-F750 batteries included — verify charged before checkout.'},
    {id:'73', batteryNote:'🔋 Battery charger included — verify batteries are charged before checkout.'},
    ...
    {id:'62', batteryNote:'🔋 MixPre-6 II recorder batteries — NP-F770 included. Verify charged before checkout.'},
    // ── Battery NOT included — must be reserved separately ─────────────────
    {id:'53', batteryNote:'🔋 Gold Mount battery mount is in the kit but the battery itself is NOT included — student must reserve a V-Mount or Gold Mount battery separately.'},
  ];
